...
#            self.data = infile.read()
    ...
    def test_exif_string(self):
        ...
        data = struct.pack('7s2B2s', b'aaaExif', 0, 0, b'MM')
    ...
    def test_get_tag_info(self):
        ...
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        tag_info = exif_data.get_tag_info(data, "0th", 0)
    ...
    def test_exif_offset(self):
        exif_data = ParseExifData()
        data = struct.pack('>4s2B2s2BL3H3L', b'Exif', 0, 0, b'MM', 0x00, 0x2a, 0x00000008, 0x0001, 0x8769, 0x0003, 0x11223344, 0xaabbccdd, 0x55667788)
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        exif_data.get_1st_ifd_offset(data, 1)
        exif_data.get_tag_info(data, "0th", 0)
        self.assertEqual(exif_data._offset["exif"], 0xaabbccdd)
        data = struct.pack('<4s2B2s2BL3H3L', b'Exif', 0, 0, b'II', 0x00, 0x2a, 0x00000008, 0x0001, 0x8769, 0x0003, 0x11223344, 0xaabbccdd, 0x55667788)
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        exif_data.get_1st_ifd_offset(data, 1)
        exif_data.get_tag_info(data, "0th", 0)
    ...
    def test_gps_offset(self):
        exif_data = ParseExifData()
        data = struct.pack('>4s2B2s2BL3H3L', b'Exif', 0, 0, b'MM', 0x00, 0x2a, 0x00000008, 0x0001, 0x8825, 0x0003, 0x11223344, 0xaabbccdd, 0x55667788)
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        exif_data.get_1st_ifd_offset(data, 1)
        exif_data.get_tag_info(data, "0th", 0)
        self.assertEqual(exif_data._offset["gps"], 0xaabbccdd)
        data = struct.pack('<4s2B2s2BL3H3L', b'Exif', 0, 0, b'II', 0x00, 0x2a, 0x00000008, 0x0001, 0x8825, 0x0003, 0x11223344, 0xaabbccdd, 0x55667788)
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        exif_data.get_1st_ifd_offset(data, 1)
        exif_data.get_tag_info(data, "0th", 0)
    ...
    def test_intr_offset(self):
        exif_data = ParseExifData()
        data = struct.pack('>4s2B2s2BL3H3L', b'Exif', 0, 0, b'MM', 0x00, 0x2a, 0x00000008, 0x0001, 0xA005, 0x0003, 0x11223344, 0xaabbccdd, 0x55667788)
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        exif_data.get_1st_ifd_offset(data, 1)
        exif_data.get_tag_info(data, "0th", 0)
        self.assertEqual(exif_data._offset["intr"], 0xaabbccdd)
        data = struct.pack('<4s2B2s2BL3H3L', b'Exif', 0, 0, b'II', 0x00, 0x2a, 0x00000008, 0x0001, 0xA005, 0x0003, 0x11223344, 0xaabbccdd, 0x55667788)
        exif_data.check_exif_string(data)
        exif_data.get_0th_offset(data)
        exif_data.get_1st_ifd_offset(data, 1)
        exif_data.get_tag_info(data, "0th", 0)
